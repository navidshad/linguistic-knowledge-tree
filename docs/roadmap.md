...
**Phase 1 — The static map + map browser**
...
**Phase 2 — Activation from data + overlay**
...
**Phase 3 — Gap detection / in-between nodes** ← headline differentiator
...
**Phase 4 — Propagation + forgetting**
...
**Phase 5 — Validation on open data** ← turns the thesis from theoretical to validated
...
**Phase 6 — Semantic embedding (BERT/K-BERT) for evidence→node mapping**
...
**Phase 7 — Personalization (KGT) + recommender handoff**
...
**Phase 0 + Phase 1:** scaffold the monorepo and build the v0 A1–C2 map + map browser. First visible milestone: the whole English syntax map, explorable in the browser.
